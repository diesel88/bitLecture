...
<c:if test="${pageResult.count != 0}">
	<nav>
	  <ul class="pagination">
	      ...
	      <a data-page="<c:if test="${pageResult.prev eq true}">${pageResult.beginPage - 1}</c:if>" href="#1" aria-label="Previous">
	      ...
	      <a data-page="${pageResult.endPage + 1}" href="#1" aria-label="Next">

...
<div class="container">
  ...
  <ul class="pagination">
      ...
      <a href="<c:if test="${pageResult.prev eq true}">list3.do?pageNo=${pageResult.beginPage-1}</c:if>" aria-label="Previous">
    ...
    <li class="<c:if test="${pageResult.next eq false}">disabled</c:if>">
      <a href="<c:if test="${pageResult.next eq true}">list3.do?pageNo=${pageResult.endPage+1}</c:if>" aria-label="Next">
